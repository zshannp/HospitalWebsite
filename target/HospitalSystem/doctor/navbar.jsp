		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link active"
					href="patient.jsp"> <i class="fa-solid fa-user-large me-2"></i>
						PATIENT
				</a></li>
			...
			<ul class="navbar-nav ms-auto">
				<li class="nav-item dropdown active"><a
					...
					aria-expanded="false"> <i class="fa-solid fa-user-md"></i> <span
						class="text-truncate" style="max-width: 150px;">${doctorObject.fullName}</span>
				</a>
					<ul class="dropdown-menu dropdown-menu-end shadow-lg"
						...
						<li><a class="dropdown-item" href="../doctorServlet/logout"> <i
								class="fa-solid fa-sign-out-alt me-2"></i> Logout
						</a></li>
					</ul></li>
			</ul>
		</div>
